...
//
//	mockgen -package release -source release.go -destination release_mocks_test.go -self_package github.com/cadence-workflow/shard-manager/cmd/tools/releaser/release
//
