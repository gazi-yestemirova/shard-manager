...
//
//	mockgen -package matching -source peer_resolver.go -destination peer_resolver_mock.go -package matching github.com/cadence-workflow/shard-manager/client/matching PeerResolver
//
