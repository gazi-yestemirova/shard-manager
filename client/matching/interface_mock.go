...
//
//	mockgen -package matching -source interface.go -destination interface_mock.go -package matching github.com/cadence-workflow/shard-manager/client/matching Client
//
