...
//
//	mockgen -package matching -source loadbalancer.go -destination loadbalancer_mock.go -package matching github.com/cadence-workflow/shard-manager/client/matching LoadBalancer,WeightedLoadBalancer
//
