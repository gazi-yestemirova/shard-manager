...
//
//	mockgen -package history -source peer_resolver.go -destination peer_resolver_mock.go -package history github.com/cadence-workflow/shard-manager/client/history PeerResolver
//
