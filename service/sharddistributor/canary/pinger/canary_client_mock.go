...
//
//	mockgen -package pinger -destination canary_client_mock.go github.com/cadence-workflow/shard-manager/.gen/proto/sharddistributor/v1 ShardDistributorExecutorCanaryAPIYARPCClient
//
