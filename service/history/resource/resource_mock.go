...
//
//	mockgen -package resource -source resource.go -destination resource_mock.go -self_package github.com/cadence-workflow/shard-manager/service/history/resource
//
...
import (
	...
	client "github.com/cadence-workflow/shard-manager/client"
	admin "github.com/cadence-workflow/shard-manager/client/admin"
	frontend "github.com/cadence-workflow/shard-manager/client/frontend"
	history "github.com/cadence-workflow/shard-manager/client/history"
	matching "github.com/cadence-workflow/shard-manager/client/matching"
	activecluster "github.com/cadence-workflow/shard-manager/common/activecluster"
	archiver "github.com/cadence-workflow/shard-manager/common/archiver"
	provider "github.com/cadence-workflow/shard-manager/common/archiver/provider"
	queue "github.com/cadence-workflow/shard-manager/common/asyncworkflow/queue"
	blobstore "github.com/cadence-workflow/shard-manager/common/blobstore"
	cache "github.com/cadence-workflow/shard-manager/common/cache"
	clock "github.com/cadence-workflow/shard-manager/common/clock"
	cluster "github.com/cadence-workflow/shard-manager/common/cluster"
	domain "github.com/cadence-workflow/shard-manager/common/domain"
	configstore "github.com/cadence-workflow/shard-manager/common/dynamicconfig/configstore"
	isolationgroup "github.com/cadence-workflow/shard-manager/common/isolationgroup"
	log "github.com/cadence-workflow/shard-manager/common/log"
	membership "github.com/cadence-workflow/shard-manager/common/membership"
	messaging "github.com/cadence-workflow/shard-manager/common/messaging"
	...
	client0 "github.com/cadence-workflow/shard-manager/common/persistence/client"
	algorithm "github.com/cadence-workflow/shard-manager/common/quotas/global/algorithm"
	rpc "github.com/cadence-workflow/shard-manager/common/quotas/global/rpc"
	...
	archiver0 "github.com/cadence-workflow/shard-manager/service/worker/archiver"
)
