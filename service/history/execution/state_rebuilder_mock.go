...
//
//	mockgen -package execution -source state_rebuilder.go -destination state_rebuilder_mock.go -self_package github.com/cadence-workflow/shard-manager/service/history/execution
//
