...
//
//	mockgen -package execution -source timer_sequence.go -destination timer_sequence_mock.go -self_package github.com/cadence-workflow/shard-manager/service/history/execution
//
