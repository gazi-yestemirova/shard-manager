...
//
//	mockgen -package execution -source state_builder.go -destination state_builder_mock.go -self_package github.com/cadence-workflow/shard-manager/service/history/execution
//
