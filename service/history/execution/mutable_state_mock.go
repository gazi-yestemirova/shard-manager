...
//
//	mockgen -package execution -source mutable_state.go -destination mutable_state_mock.go -self_package github.com/cadence-workflow/shard-manager/service/history/execution
//
...
import (
	...
	definition "github.com/cadence-workflow/shard-manager/common/definition"
	...
	query "github.com/cadence-workflow/shard-manager/service/history/query"
)
