...
//
//	mockgen -package failover -source marker_notifier.go -destination marker_notifier_mock.go -self_package github.com/cadence-workflow/shard-manager/service/history/failover
//
