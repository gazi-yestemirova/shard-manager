...
//
//	mockgen -package failover -source coordinator.go -destination coordinator_mock.go -self_package github.com/cadence-workflow/shard-manager/service/history/failover
//
