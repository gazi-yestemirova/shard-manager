...
//
//	mockgen -package ndc -source replication_task.go -destination replication_task_mock.go -self_package github.com/cadence-workflow/shard-manager/service/history/ndc
//
