...
//
//	mockgen -package shard -source controller.go -destination controller_mock.go -self_package github.com/cadence-workflow/shard-manager/service/history/shard
//
