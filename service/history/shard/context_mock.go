...
//
//	mockgen -package shard -source context.go -destination context_mock.go -package shard github.com/cadence-workflow/shard-manager/history/shard/context Context
//
...
import (
	...
	config "github.com/cadence-workflow/shard-manager/service/history/config"
	engine "github.com/cadence-workflow/shard-manager/service/history/engine"
	events "github.com/cadence-workflow/shard-manager/service/history/events"
	resource "github.com/cadence-workflow/shard-manager/service/history/resource"
)
