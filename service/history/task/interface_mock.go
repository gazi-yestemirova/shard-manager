...
//
//	mockgen -package task -source interface.go -destination interface_mock.go -self_package github.com/cadence-workflow/shard-manager/service/history/task
//
...
import (
	...
	future "github.com/cadence-workflow/shard-manager/common/future"
	persistence "github.com/cadence-workflow/shard-manager/common/persistence"
	task "github.com/cadence-workflow/shard-manager/common/task"
	types "github.com/cadence-workflow/shard-manager/common/types"
	shard "github.com/cadence-workflow/shard-manager/service/history/shard"
)
