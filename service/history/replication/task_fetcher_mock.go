...
//
//	mockgen -package replication -source task_fetcher.go -destination task_fetcher_mock.go -self_package github.com/cadence-workflow/shard-manager/service/history/replication
//
...
import (
	...
	quotas "github.com/cadence-workflow/shard-manager/common/quotas"
)
