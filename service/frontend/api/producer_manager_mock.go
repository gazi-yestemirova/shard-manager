...
//
//	mockgen -package api -source producer_manager.go -destination producer_manager_mock.go -self_package github.com/cadence-workflow/shard-manager/service/frontend/api
//
