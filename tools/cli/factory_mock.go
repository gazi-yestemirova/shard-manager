...
//
//	mockgen -package cli -source factory.go -destination factory_mock.go -self_package github.com/cadence-workflow/shard-manager/tools/cli
//
...
import (
	...
	config "github.com/cadence-workflow/shard-manager/common/config"
)
