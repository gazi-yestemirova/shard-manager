...
// Source: github.com/cadence-workflow/shard-manager/common/quotas (interfaces: Policy)
//
// Generated by this command:
//
//	mockgen -package=quotas -destination=policy_mock.go github.com/cadence-workflow/shard-manager/common/quotas Policy
//
