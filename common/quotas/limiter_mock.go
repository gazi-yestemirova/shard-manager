...
// Source: github.com/cadence-workflow/shard-manager/common/quotas (interfaces: Limiter)
//
// Generated by this command:
//
//	mockgen -package=quotas -destination=limiter_mock.go github.com/cadence-workflow/shard-manager/common/quotas Limiter
//
