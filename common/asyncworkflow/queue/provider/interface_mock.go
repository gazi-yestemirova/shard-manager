...
//
//	mockgen -package provider -source provider.go -destination interface_mock.go -self_package github.com/cadence-workflow/shard-manager/common/asyncworkflow/queue/provider
//
