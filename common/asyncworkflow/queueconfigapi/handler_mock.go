...
//
//	mockgen -package queueconfigapi -source interface.go -destination handler_mock.go -self_package github.com/cadence-workflow/shard-manager/common/asyncworkflow/queueconfigapi
//
