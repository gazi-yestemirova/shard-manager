...
//
//	mockgen -package types -source consumer.go -destination consumer_mock.go -package types github.com/cadence-workflow/shard-manager/common/mapq/types ConsumerFactory,Consumer
//
