...
//
//	mockgen -package types -source persister.go -destination persister_mock.go -package types github.com/cadence-workflow/shard-manager/common/mapq/types Persister
//
