...
//
//	mockgen -package isolationgroupapi -source interface.go -destination isolation_handler_mock.go -self_package github.com/cadence-workflow/shard-manager/common/isolationgroup/isolationgrouphandler
//
