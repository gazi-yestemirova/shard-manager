...
//
//	mockgen -package isolationgroup -source interface.go -destination isolation_group_mock.go -self_package github.com/cadence-workflow/shard-manager/common/isolationgroup
//
