...
//
//	mockgen -package common -source taskTokenSerializerInterfaces.go -destination taskTokenSerializerInterfaces_mock.go -self_package github.com/cadence-workflow/shard-manager/common
//
