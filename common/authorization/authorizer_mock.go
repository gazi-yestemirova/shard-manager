...
//
//	mockgen -package authorization -source authorizer.go -destination authorizer_mock.go -self_package github.com/cadence-workflow/shard-manager/common/authorization
//
