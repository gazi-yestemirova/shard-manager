...
//
//	mockgen -package sqldriver -source interface.go -destination interface_mock.go -self_package github.com/cadence-workflow/shard-manager/common/persistence/sql/sqldriver
//
