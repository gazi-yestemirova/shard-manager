...
// Source: github.com/cadence-workflow/shard-manager/common/persistence (interfaces: Task,ShardManager,ExecutionManager,ExecutionManagerFactory,TaskManager,HistoryManager,DomainManager,DomainAuditManager,QueueManager,ConfigStoreManager)
//
// Generated by this command:
//
//	mockgen -package persistence -destination data_manager_interfaces_mock.go github.com/cadence-workflow/shard-manager/common/persistence Task,ShardManager,ExecutionManager,ExecutionManagerFactory,TaskManager,HistoryManager,DomainManager,DomainAuditManager,QueueManager,ConfigStoreManager
//
