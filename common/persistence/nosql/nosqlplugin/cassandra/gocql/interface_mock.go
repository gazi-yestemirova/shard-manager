...
//
//	mockgen -package gocql -source interface.go -destination interface_mock.go -self_package github.com/cadence-workflow/shard-manager/common/persistence/nosql/nosqlplugin/cassandra/gocql
//
