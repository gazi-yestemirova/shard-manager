...
//
//	mockgen -package nosqlplugin -source interfaces.go -destination interfaces_mock.go -self_package github.com/cadence-workflow/shard-manager/common/persistence/nosql/nosqlplugin
//
