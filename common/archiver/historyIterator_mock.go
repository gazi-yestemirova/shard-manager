...
//
//	mockgen -package archiver -source historyIterator.go -destination historyIterator_mock.go -self_package github.com/cadence-workflow/shard-manager/common/archiver
//
