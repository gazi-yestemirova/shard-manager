...
//
//	mockgen -package dynamicconfig -source clientInterface.go -destination clientInterface_mock.go -self_package github.com/cadence-workflow/shard-manager/common/dynamicconfig
//
