...
//
//	mockgen -package membership -source hashring.go -destination peerprovider_mock.go github.com/cadence-workflow/shard-manager/common/membership PeerProvider
//
